...
void
bore_tunnel(struct cmap *, struct cmap *);
...
/**************************************************/
void
connect_cavitys(struct cmap *cavity_map, int num_cavitys)
{
	int curi, nexti;
	int i;
	int num;
...
/**************************************************/
void
bore_tunnel(struct cmap *curcav, struct cmap *nextcav)
{
	/*
...
/**************************************************/
void
get_maze_results(PROBE_MESSAGES *results)
{
	int row, col;
	int missed;
	...
	results->msg.results.lawsuits = 0; 
...
/**************************************************/
void
move_player(PROBE_MESSAGES *message, PROBE_MESSAGES *response)
{
	int nrow, ncol;
