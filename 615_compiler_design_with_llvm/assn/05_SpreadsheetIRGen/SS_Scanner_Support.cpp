...
void printEntryOptions() {
    ...
    cout << tab << "This will print the attributes of all of the cells."
         << endl;
    cout << "enter> ?" << endl;
    cout << tab << "This will print this set of entry options." << endl;
    cout << "enter> # ..." << endl;
    cout << tab << "Any line beginning with a " << '"' << '#' << '"'
    ...
    cout << tab
         << "Negative integers must not contain white space after the minus "
            "sign."
         << endl;
    cout << tab << "Integers with more than 7 digits will display as ******"
         << endl;
    cout << "enter> B3 = B2 + A1" << endl;
    cout << tab << "Any line begining with an ID and an equal sign (" << '"'
         << "=" << '"' << ")" << endl;
