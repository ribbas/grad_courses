...
public:
  ...
  virtual void enterDeclaration_list(CminusParser::Declaration_listContext *ctx) = 0;
  virtual void exitDeclaration_list(CminusParser::Declaration_listContext *ctx) = 0;
  ...
  virtual void enterType_specifier(CminusParser::Type_specifierContext *ctx) = 0;
  virtual void exitType_specifier(CminusParser::Type_specifierContext *ctx) = 0;
  ...
  virtual void enterCompound_statement(CminusParser::Compound_statementContext *ctx) = 0;
  virtual void exitCompound_statement(CminusParser::Compound_statementContext *ctx) = 0;

  virtual void enterLocal_declarations(CminusParser::Local_declarationsContext *ctx) = 0;
  virtual void exitLocal_declarations(CminusParser::Local_declarationsContext *ctx) = 0;

  virtual void enterStatement_list(CminusParser::Statement_listContext *ctx) = 0;
  virtual void exitStatement_list(CminusParser::Statement_listContext *ctx) = 0;
  ...
  virtual void enterExpression_statement(CminusParser::Expression_statementContext *ctx) = 0;
  virtual void exitExpression_statement(CminusParser::Expression_statementContext *ctx) = 0;

  virtual void enterSelection_statement(CminusParser::Selection_statementContext *ctx) = 0;
  virtual void exitSelection_statement(CminusParser::Selection_statementContext *ctx) = 0;

  virtual void enterIteration_statement(CminusParser::Iteration_statementContext *ctx) = 0;
  virtual void exitIteration_statement(CminusParser::Iteration_statementContext *ctx) = 0;

  virtual void enterReturn_statement(CminusParser::Return_statementContext *ctx) = 0;
  virtual void exitReturn_statement(CminusParser::Return_statementContext *ctx) = 0;
  ...
  virtual void enterSimple_expression(CminusParser::Simple_expressionContext *ctx) = 0;
  virtual void exitSimple_expression(CminusParser::Simple_expressionContext *ctx) = 0;

  virtual void enterRelop(CminusParser::RelopContext *ctx) = 0;
  virtual void exitRelop(CminusParser::RelopContext *ctx) = 0;

  virtual void enterAdditive_expression(CminusParser::Additive_expressionContext *ctx) = 0;
  virtual void exitAdditive_expression(CminusParser::Additive_expressionContext *ctx) = 0;
