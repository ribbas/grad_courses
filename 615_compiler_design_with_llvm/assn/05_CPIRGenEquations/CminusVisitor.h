...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitCompound_stmt(CminusParser::Compound_stmtContext *context) = 0;

    virtual antlrcpp::Any visitStatement(CminusParser::StatementContext *context) = 0;

    virtual antlrcpp::Any visitSelection_stmt(CminusParser::Selection_stmtContext *context) = 0;

    virtual antlrcpp::Any visitIteration_stmt(CminusParser::Iteration_stmtContext *context) = 0;

    virtual antlrcpp::Any visitAssignment_stmt(CminusParser::Assignment_stmtContext *context) = 0;
    ...
    virtual antlrcpp::Any visitNum_exp(CminusParser::Num_expContext *context) = 0;

    virtual antlrcpp::Any visitCall_exp(CminusParser::Call_expContext *context) = 0;

    virtual antlrcpp::Any visitVal_exp(CminusParser::Val_expContext *context) = 0;
