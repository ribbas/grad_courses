...
public:
    ...
    virtual void enterDeclaration_list(
        CminusParser::Declaration_listContext* /*ctx*/) override {}
    virtual void exitDeclaration_list(
        CminusParser::Declaration_listContext* /*ctx*/) override {}

    virtual void
    enterDeclaration(CminusParser::DeclarationContext* /*ctx*/) override {}
    virtual void
    exitDeclaration(CminusParser::DeclarationContext* /*ctx*/) override {}
    ...
    virtual void
    enterType_specifier(CminusParser::Type_specifierContext* /*ctx*/) override {
    }
    virtual void
    exitType_specifier(CminusParser::Type_specifierContext* /*ctx*/) override {}
    ...
    virtual void
    enterParam_list(CminusParser::Param_listContext* /*ctx*/) override {}
    virtual void
    exitParam_list(CminusParser::Param_listContext* /*ctx*/) override {}
    ...
    virtual void enterCompound_statement(
        CminusParser::Compound_statementContext* /*ctx*/) override {}
    virtual void exitCompound_statement(
        CminusParser::Compound_statementContext* /*ctx*/) override {}

    virtual void enterLocal_declarations(
        CminusParser::Local_declarationsContext* /*ctx*/) override {}
    virtual void exitLocal_declarations(
        CminusParser::Local_declarationsContext* /*ctx*/) override {}

    virtual void
    enterStatement_list(CminusParser::Statement_listContext* /*ctx*/) override {
    }
    virtual void
    exitStatement_list(CminusParser::Statement_listContext* /*ctx*/) override {}
    ...
    virtual void enterSelection_statement(
        CminusParser::Selection_statementContext* /*ctx*/) override {}
    virtual void exitSelection_statement(
        CminusParser::Selection_statementContext* /*ctx*/) override {}

    virtual void enterIteration_statement(
        CminusParser::Iteration_statementContext* /*ctx*/) override {}
    virtual void exitIteration_statement(
        CminusParser::Iteration_statementContext* /*ctx*/) override {}

    virtual void enterReturn_statement(
        CminusParser::Return_statementContext* /*ctx*/) override {}
    virtual void exitReturn_statement(
        CminusParser::Return_statementContext* /*ctx*/) override {}

    virtual void
    enterExpression(CminusParser::ExpressionContext* /*ctx*/) override {}
    virtual void
    exitExpression(CminusParser::ExpressionContext* /*ctx*/) override {}

    virtual void enterVar(CminusParser::VarContext* /*ctx*/) override {}
    virtual void exitVar(CminusParser::VarContext* /*ctx*/) override {}

    virtual void enterSimple_expression(
        CminusParser::Simple_expressionContext* /*ctx*/) override {}
    virtual void exitSimple_expression(
        CminusParser::Simple_expressionContext* /*ctx*/) override {}
    ...
    virtual void enterAdditive_expression(
        CminusParser::Additive_expressionContext* /*ctx*/) override {}
    virtual void exitAdditive_expression(
        CminusParser::Additive_expressionContext* /*ctx*/) override {}
    ...
    virtual void
    enterArg_list(CminusParser::Arg_listContext* /*ctx*/) override {}
