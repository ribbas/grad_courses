...
public:
    ...
    enum {
        RuleProgram = 0,
        RuleDeclaration_list = 1,
        RuleDeclaration = 2,
        RuleVar_declaration = 3,
        RuleType_specifier = 4,
        RuleFun_declaration = 5,
        RuleParams = 6,
        RuleParam_list = 7,
        RuleParam = 8,
        RuleCompound_statement = 9,
        RuleLocal_declarations = 10,
        RuleStatement_list = 11,
        RuleStatement = 12,
        RuleExpression_statement = 13,
        RuleSelection_statement = 14,
        RuleIteration_statement = 15,
        RuleReturn_statement = 16,
        RuleExpression = 17,
        RuleVar = 18,
        RuleSimple_expression = 19,
        RuleRelop = 20,
        RuleAdditive_expression = 21,
        RuleAddop = 22,
        RuleTerm = 23,
        RuleMulop = 24,
        RuleFactor = 25,
    ...
    public:
        Declaration_listContext(antlr4::ParserRuleContext* parent,
    ...
    public:
        Type_specifierContext(antlr4::ParserRuleContext* parent,
                              size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    public:
        Param_listContext(antlr4::ParserRuleContext* parent,
                          size_t invokingState);
        virtual size_t getRuleIndex() const override;
        ParamContext* param();
        Param_listContext* param_list();
    ...
    public:
        Compound_statementContext(antlr4::ParserRuleContext* parent,
                                  size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    public:
        Local_declarationsContext(antlr4::ParserRuleContext* parent,
                                  size_t invokingState);
        virtual size_t getRuleIndex() const override;
        Local_declarationsContext* local_declarations();
        Var_declarationContext* var_declaration();
    ...
    public:
        Statement_listContext(antlr4::ParserRuleContext* parent,
                              size_t invokingState);
        virtual size_t getRuleIndex() const override;
        Statement_listContext* statement_list();
    ...
    public:
        Expression_statementContext(antlr4::ParserRuleContext* parent,
                                    size_t invokingState);
        virtual size_t getRuleIndex() const override;
        antlr4::tree::TerminalNode* SEMICOLON();
    ...
    public:
        Selection_statementContext(antlr4::ParserRuleContext* parent,
                                   size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    public:
        Iteration_statementContext(antlr4::ParserRuleContext* parent,
                                   size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    public:
        CminusParser::Simple_expressionContext* simple_expressionContext =
            nullptr;
        Return_statementContext(antlr4::ParserRuleContext* parent,
                                size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    public:
        Simple_expressionContext(antlr4::ParserRuleContext* parent,
                                 size_t invokingState);
        virtual size_t getRuleIndex() const override;
    ...
    public:
        Additive_expressionContext(antlr4::ParserRuleContext* parent,
                                   size_t invokingState);
        virtual size_t getRuleIndex() const override;
        TermContext* term();
    ...
    public:
        Arg_listContext(antlr4::ParserRuleContext* parent,
                        size_t invokingState);
        virtual size_t getRuleIndex() const override;
        ExpressionContext* expression();
        Arg_listContext* arg_list();
    ...
    bool declaration_listSempred(Declaration_listContext* _localctx,
                                 size_t predicateIndex);
    bool var_declarationSempred(Var_declarationContext* _localctx,
                                size_t predicateIndex);
    bool fun_declarationSempred(Fun_declarationContext* _localctx,
                                size_t predicateIndex);
    ...
    bool local_declarationsSempred(Local_declarationsContext* _localctx,
                                   size_t predicateIndex);
    bool statement_listSempred(Statement_listContext* _localctx,
                               size_t predicateIndex);
    bool return_statementSempred(Return_statementContext* _localctx,
                                 size_t predicateIndex);
    bool expressionSempred(ExpressionContext* _localctx, size_t predicateIndex);
    bool varSempred(VarContext* _localctx, size_t predicateIndex);
    bool additive_expressionSempred(Additive_expressionContext* _localctx,
                                    size_t predicateIndex);
