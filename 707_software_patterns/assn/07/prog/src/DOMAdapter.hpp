#ifndef DOM_ADAPTER_HPP
#define DOM_ADAPTER_HPP
...
protected:
    Node(const std::string& name, short type, dom::Document* document)
...
public:
    ...
    virtual void* setUserData(const XERCES::XMLCh* key, void* data,
    ...
    virtual const XERCES::XMLCh*
    lookupPrefix(const XERCES::XMLCh* namespaceURI) const {
        return 0;
    }
    ...
    virtual const XERCES::XMLCh*
    lookupNamespaceURI(const XERCES::XMLCh* prefix) const {
        return 0;
    }
    virtual void* getFeature(const XERCES::XMLCh* feature,
                             const XERCES::XMLCh* version) const {
        return 0;
    }
...
public:
    ...
    virtual XERCES::DOMCDATASection*
    createCDATASection(const XERCES::XMLCh* data) {
        return 0;
    }
    virtual XERCES::DOMProcessingInstruction*
    createProcessingInstruction(const XERCES::XMLCh* adaptee,
                                const XERCES::XMLCh* data) {
        return 0;
    }
    virtual XERCES::DOMEntityReference*
    createEntityReference(const XERCES::XMLCh* name) {
        return 0;
    }
    ...
    getElementsByTagName(const XERCES::XMLCh* tagname) const {
        return 0;
    }
    virtual XERCES::DOMNode* importNode(const XERCES::DOMNode* importedNode,
                                        bool deep) {
        return 0;
    }
    virtual XERCES::DOMElement*
    createElementNS(const XERCES::XMLCh* namespaceURI,
                    const XERCES::XMLCh* qualifiedName) {
        return 0;
    }
    virtual XERCES::DOMAttr*
    createAttributeNS(const XERCES::XMLCh* namespaceURI,
                      const XERCES::XMLCh* qualifiedName) {
        return 0;
    }
    virtual XERCES::DOMNodeList*
    getElementsByTagNameNS(const XERCES::XMLCh* namespaceURI,
                           const XERCES::XMLCh* localName) const {
        return 0;
    }
    virtual XERCES::DOMElement*
    getElementById(const XERCES::XMLCh* elementId) const {
        return 0;
    }
    ...
    virtual XERCES::DOMNode* renameNode(XERCES::DOMNode* n,
                                        const XERCES::XMLCh* namespaceURI,
                                        const XERCES::XMLCh* qualifiedName) {
        return 0;
    }
    ...
    virtual XERCES::DOMDocumentType*
    createDocumentType(const XERCES::XMLCh* name) {
        return 0;
    }
    virtual XERCES::DOMNotation* createNotation(const XERCES::XMLCh* name) {
        return 0;
    }
    virtual XERCES::DOMElement* createElementNS(
        const XERCES::XMLCh* namespaceURI, const XERCES::XMLCh* qualifiedName,
        const XERCES::XMLFileLoc lineNum, const XERCES::XMLFileLoc columnNum) {
        return 0;
    }
};
}; // namespace adapter
