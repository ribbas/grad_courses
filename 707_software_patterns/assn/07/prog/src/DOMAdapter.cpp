...
XERCES::DOMNode* adapter::Node::getPreviousSibling() const {
    return dynamic_cast<XERCES::DOMNode*>(
        new Node(adaptee->getPreviousSibling()));
}
...
XERCES::DOMNode* adapter::Node::insertBefore(XERCES::DOMNode* newChild,
    ...
    return dynamic_cast<XERCES::DOMNode*>(new Node(
        adaptee->insertBefore(dynamic_cast<Node*>(newChild)->getAdaptee(),
...
XERCES::DOMNode* adapter::Node::replaceChild(XERCES::DOMNode* newChild,
    ...
    return dynamic_cast<XERCES::DOMNode*>(new Node(
        adaptee->replaceChild(dynamic_cast<Node*>(newChild)->getAdaptee(),
