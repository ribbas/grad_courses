...
const std::string &Text_Impl::getName(void) { return getNodeName(); }

const std::string &Text_Impl::getData(void) { return getNodeValue(); }

const std::string &Text_Impl::getValue(void) { return getData(); }

void Text_Impl::setData(const std::string &value) { setNodeValue(value); }

void Text_Impl::setValue(const std::string &value) { setNodeValue(value); }

int Text_Impl::getLength(void) { return getValue().size(); }
...
dom::Text *Text_Impl::splitText(int offset) {
  try {
    dom::Text *text =
        new Text_Impl(substringData(offset, getLength() - offset), document);
