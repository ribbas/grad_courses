 ...
 */
Date::Date()
    : year_set_(false), month_set_(false), day_set_(false), is_leap_(false),
      month_(-1), day_(-1), year_(-1) {
 ...
 * The constructor sets the year, month and day in order to enforce their
...
/*
 * Set day of date.
 * The method verifies the day being set for the date is valid based on the year
 * and month.
 *
 * Params:
 *  day <int>: day of the date
    ...
    if (month_set_ && year_set_) {
        ...
        if (day > 0) {
            ...
            switch (month_) {
                ...
                // if any of the conditions above fail, invoke the default case
                // of throwing a std::invalid_argument exception
                default: {
                    throw std::invalid_argument("Invalid date for " +
                                                get_month_name(false));
                }
            }
        ...
        // if day is trying to be set before the year and month, throw a
        // std::invalid_argument exception
        throw std::invalid_argument(
            "Please initialize the month and year of the date first");
    }
}
 ...
 *
 * Params:
 *  shortened <bool (default=false)>: if true, returns the first 3 characters of
 * the month name
 *
 * Returns:
